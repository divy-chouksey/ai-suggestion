...
Cohere is used for structured intent extraction when \texttt{COHERE\_API\_KEY} is set. The default model is \texttt{command-r7b-12-2024}.
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Cohere:} \texttt{POST https://api.cohere.ai/v2/chat}. Uses \texttt{command-r7b-12-2024} for structured intent extraction when \texttt{COHERE\_API\_KEY} is set.
\end{itemize}
